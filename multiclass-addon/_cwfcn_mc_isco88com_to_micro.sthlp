...
{title:Syntax}
        ...
        {cmd:mc.isco88com_to_micro(}{it:varname} {it:case}{cmd:)}
...
{pstd}
    Typical usage:
        ...
        {cmd:mc.isco88com_to_micro(}{it:varname} {cmd:case.mcempstat(}{it:sempl} {it:supvis}{cmd:)}{cmd:)}
...
{pstd}
    {cmd:mc_isco88com_to_micro()} is implemented as a wrapper for
    {helpb _cwfcn_isco88_to_isco88_3:isco88_to_isco88_3()} followed by
    {helpb _cwfcn_mc_isco88_3_to_micro:mc_isco88_3_to_micro()}.
    {p_end}
