...
{hi:mc_isco88_3_to_meso()} {hline 2} Translate 3-digit ISCO-88(com) to meso-class
...
{pstd}
    Derived from the micro-class via the deterministic micro-class to meso-class map (30 -> 18).
    {p_end}
