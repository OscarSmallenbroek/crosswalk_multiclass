...
{hi:mc_isco88com_to_esecmp()} {hline 2} Translate 4-digit ISCO-88(com) to ESeC-MP

{title:Syntax}

        {cmd:mc.isco88com_to_esecmp(}{it:varname} {it:case}{cmd:)}
...
{pstd}
    Typical usage:
        ...
        {cmd:mc.isco88com_to_esecmp(}{it:varname} {cmd:case.mcempstat(}{it:sempl} {it:supvis}{cmd:)}{cmd:)}
...
{pstd}
    {cmd:mc_isco88com_to_esecmp()} is implemented as a wrapper for
    {helpb _cwfcn_isco88_to_isco88_3:isco88_to_isco88_3()} followed by
    {helpb _cwfcn_mc_isco88_3_to_esecmp:mc_isco88_3_to_esecmp()}.
    {p_end}
